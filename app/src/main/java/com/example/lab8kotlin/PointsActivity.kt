...
class PointsActivity : AppCompatActivity(), OnMapReadyCallback {

    private var mMap: GoogleMap? = null
    private var TAG = PointsActivity::class.simpleName
    private lateinit var mapFragment: SupportMapFragment

    private var selectedPlaceLL: LatLng = LatLng(-33.868623, 151.208652)
    ...
    private fun setupAutoCompleteFragment() {
        ...
        autocompleteFragmentOrigin.setOnPlaceSelectedListener(object :
            ...
            override fun onPlaceSelected(place: Place) {
                ...
                mapFragment.getMapAsync(this@PointsActivity)
    ...
    fun onClickGoToRoutes(view: View) {
        if(originLat != 0.0 && originLong != 0.0 &&
            ...
            val goToRoutes = Intent(this, RoutesActivity::class.java)
            ...
            Toast.makeText(this, "Enter origin and destination previously"
